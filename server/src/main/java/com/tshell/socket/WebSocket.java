...
public class WebSocket {
    ...
    public enum MsgType {
        PROGRESS, CMD, RETRIEVE_CMD,OPEN_FILE,OPEN_FILE_PROGRESS,TRANSFER_COMPLETE,DOWNLOAD_FILE_PROGRESS,UPLOAD_FILE_PROGRESS,UPLOAD_FILE_COMPLETE,DOWNLOAD_FILE_COMPLETE
    }
